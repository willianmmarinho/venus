            ...
            <form action="/gerenciar-setor" class="form-horizontal mt-4" method="GET">
                <div class="row">
                    ...
                    <div class="col"><br>
                        ...
                        <a href="/gerenciar-setor"><input class="btn btn-light btn-sm me-md-2" style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="button" value="Limpar"></a>
                    </form>
                    <a href="/criar-setor"><input class="btn btn-success btn-sm me-md-2" style="font-size: 0.9rem;" type="button" value="Novo +"></a>
            ...
            <table class="table table-sm table-striped table-bordered border-secondary table-hover align-middle">
                ...
                <tbody style="font-size: 14px; color:#000000; text-align:center;">
                    ...
                    <tr>
                        ...
                        <td>{{ $setor->sigla }}</td>
                        <td>
                            <a href="/editar-setor/{{ $setor->id }}" type="button" class="btn btn-outline-warning btn-sm tooltips">
                                <span class="tooltiptext">Editar</span>
                                <i class="bi bi-pencil" style="font-size: 1rem; color:#000;"></i>
                            </a>
                            <a href="/visualizar-setor/{{ $setor->id }}" type="button" class="btn btn-outline-primary btn-sm tooltips">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer mt-3">
                                            ...
                                            <a type="button" class="btn btn-primary" href="/excluir-setor/{{ $setor->id }}">Confirmar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
