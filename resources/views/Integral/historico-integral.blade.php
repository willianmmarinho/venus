            ...
            <div class="col-12">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="d-md-flex justify-content-md-end col">
                                <a href="/gerenciar-integral?grupo={{ current(current($result))->id_reuniao }}"
                                    class=" btn-sm" style="color: red"><i class="bi bi-x-lg"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <input type="text" id="" value="{{ current(current($result))->nm_1 }}"
                                    class="form-control" placeholder="Disabled input" disabled>
                            </div>
                            <div class="col-2">
                                <label for="disabledTextInput" class="form-label">Sexo:</label>
                                <input type="text" id="" value="{{ current(current($result))->tipo }}"
                                    style="text-align:center;" class="form-control" placeholder="Disabled input" disabled>
                            </div>
                            <div class="col-3">
                                <label for="disabledTextInput" class="form-label">Dt nascimento:</label>
                                <input type="date" class="form-control" id="" name="date"
                                    value="{{ current(current($result))->dt_nascimento }}" class="form-control"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-sm table-bordered table-striped">
                            ...
                            <tbody>
                                <tr style="text-align:center;font-size:13px">
                                    ...
                                    <td>{{ current(current($result))->dt_fim ? date('d-m-Y', strtotime(current(current($result))->dt_fim)) : '-' }}
                                    </td>
                        ...
                        @if (current(current($result))->cod_tca)
                            <legend
                                style="color:#62829d; font-size:12px; font-weight:bold; font-family:Verdana, Geneva, Tahoma, sans-serif">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <legend
                            style="color:#62829d; font-size:12px; font-weight:bold; font-family:Verdana, Geneva, Tahoma, sans-serif">
                            Dados de Presenças {{ isset($encaminhamento->id_tipo_tratamento ) ?  $encaminhamento->id_tipo_tratamento == 2 ? 'PTI' : 'PTD' : null}}</legend>
                        Nr de faltas: {{ $faul2 }}
                        <table class="table table-sm table-bordered table-striped">
                            <thead style="text-align:center; background: #daffe0;">
                                <tr style="text-align:center; font-weight: bold; font-size:12px">
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="d-grid gap-1 col-4 mx-auto">
                        <a class="btn btn-danger"
                            href="/gerenciar-integral?grupo={{ current(current($result))->id_reuniao }}"
