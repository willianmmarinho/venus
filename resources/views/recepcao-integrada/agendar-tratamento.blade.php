@extends('layouts.app')
@section('title', 'Agendar Tratamento')
@section('content')
<br>
<div class="container">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-2">Encaminhamento
                            <input class="form-control" style="text-align:left; font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);" value="{{$result->ide}}" name="" id="" type="text" disabled>
                        </div>

                        <div class="col">Assistido
                            <input class="form-control" style="font-weight:bold; background:#f3f3f3; color:#000;" type="text" name="" id="" value="{{$result->nm_1}}" disabled>
                        </div>

                        <div class="col">Representante
                            <input class="form-control" style="font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);" value="{{$result->nm_2}}" name="" id="" type="text" disabled>
                        </div>
                        <div class="col">Tratamento
                            <input class="form-control" style="font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);" value="{{$result->desctrat}}" name="" id="" type="text" disabled>
                        </div>
                    </div>
                    </fieldset>
                    <br />
                    <div class="row">
                        <div class="col">Dia da semana:
                            <input class="form-control" style="font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);" value="{{current(current($trata))->nomed}}" name="" id="" type="text" disabled>
                        </div>
                        <form class="form-horizontal mt-4" method="POST" action="/incluir-tratamento/{{$result->ide}}">
                        @csrf
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{current(current($tratasDoHorario))->idr }}" aria-expanded="false" aria-controls="flush-collapse{{current(current($tratasDoHorario))->idr }}">
                               <label> {{date('H:i:s', strtotime($horario))}} -
                                ...
                                <div id="flush-collapse{{current(current($tratasDoHorario))->idr }}" class="accordion-collapse collapse" aria-labelledby="{{current(current($tratasDoHorario))->idr }}" data-bs-parent="#accordionFlushExample">
                                    ...
                                    @foreach($tratasDoHorario as $tratas)
                                        ...
                                        <table class="table table-sm table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <td>{{$tratas->trat}}</td>
                                                <td><center><input type="radio" class="form-check" name="reuniao" id="" value="{{$tratas->idr}}" autocomplete="off" required></center>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
